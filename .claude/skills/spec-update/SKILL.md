...
# /spec-update — specs/ を永続的なプロジェクト知識として管理する
...
- specs/{機能名}/*.mdは`.claude/skills/spec-update/templates/spec-feature.md`のテンプレートを必ず参照すること
...
```
specs/
  README.md                    # サービス全体の概要・機能一覧（各機能 README へのリンク）
...
4. `specs/README.md` を生成する:
   - サービス全体の概要を記述する
   - 各機能の1行説明と `specs/{機能名}/README.md` へのリンクを表形式でまとめる
5. レビュー用サマリーを提示する
...
5. `specs/README.md` の機能一覧を最新状態に同期する:
