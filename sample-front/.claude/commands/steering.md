---
description: sample-front Manage docs/steering/ as persistent project knowledge
...
- Light references to `docs/specs/` and `docs/steering/` are acceptable; avoid other `docs/` directories
